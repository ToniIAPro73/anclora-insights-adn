...
Declaración de adopción AOS para `anclora-insights-adn`.

## Metadatos

- Repository Name: anclora-insights-adn
...
`anclora-insights-adn` forma parte del ecosistema Anclora como aplicación operativa Vite + React.
